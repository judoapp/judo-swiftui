...
public enum Font: Hashable {
    ...
    public enum Emphasis: String, Codable, Hashable, CaseIterable, CustomStringConvertible {
        case bold
        case italic
    ...
    case dynamic(textStyle: FontTextStyle, emphases: Set<Emphasis>)
...
extension Font: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "dynamic":
            ...
            let emphases = try container.decode(Set<Emphasis>.self, forKey: .emphases)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .dynamic(let textStyle, let emphases):
            ...
            try container.encode(emphases, forKey: .emphases)
