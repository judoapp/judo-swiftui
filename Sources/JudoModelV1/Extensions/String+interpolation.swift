...
extension String {
    public func evaluatingExpressions(data: Any?, urlParameters: UserInfo, userInfo: UserInfo) throws -> String {
        try ExpressionEvaluator(data: data, urlParameters: urlParameters, userInfo: userInfo)
...
private struct ExpressionHelper {
    ...
    private let urlParameters: UserInfo
