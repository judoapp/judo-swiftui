...
extension KeyedDecodingContainer {
    ...
    public func decodeNodeIfPresent(forKey key: K) throws -> Node? {
...
private struct NodeWrapper: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        case AppBar.typeName:
            node = try AppBar(from: decoder)
        case AppBarMenuItem.typeName:
            node = try AppBarMenuItem(from: decoder)
        ...
        case WebViewNode.typeName:
            node = try WebViewNode(from: decoder)
