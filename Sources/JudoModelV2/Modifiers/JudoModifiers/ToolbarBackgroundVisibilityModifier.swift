...
public class ToolbarBackgroundVisibilityModifier: JudoModifier {
    @Published public var visibility: Visibility = .automatic
    ...
    public override func copy(with zone: NSZone? = nil) -> Any {
        let modifier = super.copy(with: zone) as! ToolbarBackgroundVisibilityModifier
