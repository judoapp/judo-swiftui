...
public struct NavigationBarTitleDisplayModeModifier: Modifier {
    public var id: UUID
    ...
    public init(id: UUID, name: String?, children: [Node], position: CGPoint, isLocked: Bool, titleDisplayMode: TitleDisplayMode) {
        self.id = id
        self.name = name
