...
public final class DocumentColor: ObservableObject, Codable, Equatable, Hashable {
    public init(id: UUID, name: String, color: ColorValue, variants: [Set<FillSelector>: ColorValue]) {
        self.id = id
        self.name = name
        self.color = color
    ...
    public var variants: [Set<FillSelector>: ColorValue]
    ...
    public required init(from decoder: Decoder) throws {
        ...
        variants = [Set<FillSelector>: ColorValue]()
