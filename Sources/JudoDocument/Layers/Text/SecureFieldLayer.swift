...
public struct SecureFieldLayer: Layer {
    public var id: UUID
    ...
    public init(id: UUID, name: String?, children: [Node], position: CGPoint, frame: Frame, isLocked: Bool, title: Variable<String>, text: Variable<String>) {
        self.id = id
        self.name = name
