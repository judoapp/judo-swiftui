...
public struct SpacerLayer: Layer {
    public var id: UUID
    ...
    public dynamic var minLength: Variable<Double>?

    public init(id: UUID, name: String?, children: [Node], position: CGPoint, frame: Frame, isLocked: Bool, minLength: Variable<Double>?) {
        self.id = id
        self.name = name
