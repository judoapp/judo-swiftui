...
public struct HStackLayer: Layer {
    public var id: UUID
    ...
    public init(id: UUID, name: String?, children: [Node], position: CGPoint, frame: Frame, isLocked: Bool, alignment: VerticalAlignment, spacing: CGFloat) {
        self.id = id
        self.name = name
